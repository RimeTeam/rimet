...
function adjustFullScreenSize() {
	$(".fullSizeWindow .spwincontent").css("width", (window.innerWidth - 32));
	$(".fullSizeWindow .spwincontent").css("height", (window.innerHeight - 98));
}
...
$(document).ready(function(){
    ...
    $(".winmaximize").click(function(){
		if ($(this).parent().parent().hasClass('fullSizeWindow')) {			// minimize
			...
			$(this).parent().parent().children(".spwincontent").height(minimizedHeight[$(this).parent().parent().attr("data-id")]);	
			$(this).parent().parent().children(".spwincontent").width(minimizedWidth[$(this).parent().parent().attr("data-id")]);
		} else {															// maximize
			$(this).parent().parent().addClass('fullSizeWindow');
			
			minimizedHeight[$(this).parent().parent().attr('data-id')] = $(this).parent().parent().children(".spwincontent").height();
			minimizedWidth[$(this).parent().parent().attr('data-id')] = $(this).parent().parent().children(".spwincontent").width();
